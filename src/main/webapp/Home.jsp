...
<body>
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
				 ...
				 <c:if test="${sessionScope.account==null}">
						...
						</c:if> <c:if test="${sessionScope.account.isAdmin==1}">
							<li class="nav-item"><a class="nav-link" href="AddNew.jsp">AddNew</a></li>
							<li class="nav-item"><a class="nav-link" href="DeleteServlet">Delete</a></li>
						</c:if></li>
				</ul>
				<form class="d-flex">
	...
	<header class="bg-dark py-5">
		<div class="container px-4 px-lg-5 my-5">
			<div class="text-center text-white">
				<h1 class="display-4 fw-bolder">MINH CHUONG WATCH</h1>
	...
	<footer class="py-5 bg-dark">
		<div class="container">
			<p class="m-0 text-center text-white">Copyright by DONG HO MINH CHUONG &copy; Your Website 2022</p>
			<p class="m-0 text-center text-white">Chu so huu Website: Ha Minh Chuong - So: 41A8034825 - Ngay Cap: 25/12/2002</p>
			<p class="m-0 text-center text-white">Lien he SDT: 0327.562.729</p>
			<p class="m-0 text-center text-white">Gmail: haminhchuong.2002@gmail.com</p>
		</div>
	</footer>
	<!-- Bootstrap core JS-->
	<script
